...
img_tijera = tk.PhotoImage(file="tijera.png").subsample(3,3)
...
boton_papel = tk.Button(frame_jugador, text="Papel", width=100, height=100, image=img_papel,
                        compound="top", command=lambda: jugar_mostrar("papel"))
boton_tijera = tk.Button(frame_jugador, text="Tijera", width=100, height=100, image=img_tijera,
                         compound="top", command=lambda: jugar_mostrar("tijera"))
